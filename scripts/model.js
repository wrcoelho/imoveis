/**
 * backbone model definitions for Imoveis
 */
...
/**
 * Imovel Backbone Model
 */
model.ImovelModel = Backbone.Model.extend({
	urlRoot: 'api/imovel',
	idAttribute: 'id',
	id: '',
	titulo: '',
...
/**
 * Imovel Backbone Collection
 */
model.ImovelCollection = model.AbstractCollection.extend({
	url: 'api/imovels',
	model: model.ImovelModel
});

/**
 * TipoImovel Backbone Model
 */
model.TipoImovelModel = Backbone.Model.extend({
	urlRoot: 'api/tipoimovel',
	idAttribute: 'id',
	id: '',
	descricao: '',
	defaults: {
...
/**
 * TipoImovel Backbone Collection
 */
model.TipoImovelCollection = model.AbstractCollection.extend({
	url: 'api/tipoimovels',
	model: model.TipoImovelModel
});
