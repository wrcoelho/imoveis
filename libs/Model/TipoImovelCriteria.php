...
require_once("DAO/TipoImovelCriteriaDAO.php");

/**
 * The TipoImovelCriteria class extends TipoImovelDAOCriteria and is used
 ...
 * @version 1.0
 */
class TipoImovelCriteria extends TipoImovelCriteriaDAO
{
