<?php
	$this->assign('title','Imoveis | Home');
...
?>
	...
	<div class="container">
		...
		<div class="hero-unit">
			...
			Rodando com Phreeze <?php $this->eprint($this->PHREEZE_VERSION); ?><?php if ($this->PHREEZE_PHAR) { $this->eprint(' (' . basename($this->PHREEZE_PHAR) . ')'); } ?>.</em></p>
